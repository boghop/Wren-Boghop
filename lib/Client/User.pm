...
#    $hash_ref->{url}   = "http://ec2-54-211-235-101.compute-1.amazonaws.com"   . "/wren/nopwdlogin";
    $hash_ref->{url}   = "http://boghop.net"   . "/wren/nopwdlogin";
...
#        my $cookie_domain = "ec2-54-211-235-101.compute-1.amazonaws.com";
        my $cookie_domain = "boghop.net";
